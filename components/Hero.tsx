...
export function Hero() {
  return (
    <section className="pt-32 md:pt-40 pb-10 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-base text-text-secondary leading-relaxed mb-8 max-w-xl">
            I like understanding how things work at the bottom, then building
            something useful on top. I care about the whole stack and the
            decisions that connect it.
          </p>
